...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      hardware_samples: {
        Row: {
          ...
          created_at: string
          device_id: string
          device_time_seconds: number | null
          device_timestamp_raw: string | null
          gsr: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "hardware_samples_device_id_fkey"
            columns: ["device_id"]
            isOneToOne: false
            referencedRelation: "sensor_devices"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "hardware_samples_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "sessions"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "hardware_samples_stream_id_fkey"
            columns: ["stream_id"]
            isOneToOne: false
            referencedRelation: "hardware_streams"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "hardware_samples_trial_id_fkey"
            columns: ["trial_id"]
            isOneToOne: false
      ...
      hardware_streams: {
        Row: {
          client_monotonic_start_ms: number | null
          ...
          hardware_start_time_seconds: number | null
          id: string
        ...
        Relationships: [
          {
            foreignKeyName: "hardware_streams_device_id_fkey"
            columns: ["device_id"]
            isOneToOne: false
            referencedRelation: "sensor_devices"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "hardware_streams_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "sessions"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "hardware_streams_trial_id_fkey"
            columns: ["trial_id"]
            isOneToOne: false
            referencedRelation: "trials"
            referencedColumns: ["id"]
      ...
      sensor_devices: {
        ...
        Relationships: [
          {
            foreignKeyName: "sensor_devices_center_id_fkey"
            columns: ["center_id"]
            isOneToOne: false
            referencedRelation: "centers"
            referencedColumns: ["id"]
      ...
      wearable_metrics: {
        ...
        Relationships: [
          {
            foreignKeyName: "wearable_metrics_telemetry_id_fkey"
            columns: ["telemetry_id"]
            isOneToOne: true
            referencedRelation: "device_telemetry"
            referencedColumns: ["id"]
          },
        ]
      }
      wearable_samples: {
        ...
        Relationships: [
          {
            foreignKeyName: "wearable_samples_device_id_fkey"
            columns: ["device_id"]
            isOneToOne: false
            referencedRelation: "sensor_devices"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "wearable_samples_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "sessions"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      expire_stale_online_devices: { Args: never; Returns: undefined }
      ...
      search_activities_by_child_profile: {
        Args: {
          p_child_id: string
          p_limit?: number
          p_query_embedding?: string
          p_use_semantic_search?: boolean
        }
        Returns: {
          activity_id: string
